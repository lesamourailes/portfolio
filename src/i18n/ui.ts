...
export const ui = {
  nav: {
    ...
    communities: { ru: 'Сообщества', en: 'Communities' },
  ...
  hero: {
    ...
    cta_experience: { ru: 'Смотреть опыт', en: 'View experience' },
  },
  sections: {
    about: { ru: 'Обо мне', en: 'About' },
    ...
    portfolio: { ru: 'Портфолио', en: 'Portfolio' },
    communities: { ru: 'Сообщества и признание', en: 'Communities & recognition' },

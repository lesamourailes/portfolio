...
export const services: Service[] = [
  {
    ...
    promise: { ru: 'Сильный продуктовый лидер без найма в штат', en: 'A senior product leader without a full-time hire' },
    fit: { ru: 'Продукт есть, но им никто не управляет', en: 'You have a product, but no one is steering it' },
    does: [
      { ru: 'Подготовлю стратегию и Roadmap', en: 'I’ll set the strategy and roadmap' },
      { ru: 'Discovery и дерево метрик', en: 'Discovery and a metrics tree' },
      { ru: 'Подружу стейкхолдеров', en: 'Align the stakeholders' },
      { ru: 'P&L и метрики успеха', en: 'P&L and success metrics' },
    ],
    anchor: { ru: 'В SmartMerch так вырастил линейку с 1 до 6 продуктов, что принесло +62% MRR в 25 странах мира', en: 'At SmartMerch this grew the portfolio 1→6 products, bringing +62% MRR across 25 countries' },
  },
  {
    title: { ru: 'Аудит и стратегия', en: 'Audit & strategy' },
    promise: { ru: 'Разбираемся, почему продукт не растёт и что с этим делать', en: 'We work out why the product isn’t growing and what to do about it' },
    fit: { ru: 'Метрики падают, а гипотезы не приносят результата', en: 'Metrics are dropping and hypotheses aren’t paying off' },
    does: [
      { ru: 'Аудит продукта, метрик и unit-экономики', en: 'Audit of product, metrics and unit economics' },
      { ru: 'Анализ воронки, CustDev', en: 'Funnel analysis, customer development' },
      { ru: 'Найду точки роста, исправлю узкие места', en: 'Find growth points, fix the bottlenecks' },
      { ru: 'План с прогнозом эффекта', en: 'An action plan with an impact forecast' },
    ],
  ...
  },
  {
    ...
    promise: { ru: 'От идеи до продукта с первыми клиентами', en: 'From idea to a product with its first customers' },
    fit: { ru: 'Есть идея, но нет продуктовой экспертизы', en: 'You have an idea, but lack product expertise' },
    does: [
      { ru: 'Анализ рынка и CustDev', en: 'Market analysis and customer development' },
      { ru: 'Unit-экономика и бизнес-модель', en: 'Unit economics and business model' },
      { ru: 'MVP и go-to-market', en: 'MVP and go-to-market' },
      { ru: 'Первые продажи и структура команды', en: 'First sales and team structure' },
    ],
    anchor: { ru: 'За 3 месяца запустил совместный продукт с hh.ru', en: 'Launched a joint product with hh.ru in 3 months' },
  },
];

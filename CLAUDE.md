...
6. Скриншоты превью на этой странице часто отваливаются по таймауту (много картинок) — проверять через DOM/curl.
...
- Ассоциации: Хакатоны России (2026), Expinet (2026), ProductCamp (2025), GetMentor (2025), GlobalCIO (2018) — с логотипами. Лого Expinet **сгенерирован** (`public/logos/expinet.svg`) — заменить, если появится настоящий.
